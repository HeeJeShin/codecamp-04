  ...
  return (
    <S.Wrapper>
      ...
      <S.Wrapper_MyUseditem>
        <S.MyLabel>상품{props.isEdit ? "수정하기" : "등록하기"}</S.MyLabel>
        <S.MyUseditem
          type="text"
      ...
      <S.Wrapper_MyTags>
        ...
        <S.MyTag type="text" placeholder="#태그 #태그 # 태그" />
      </S.Wrapper_MyTags>
      <S.Wrapper_Mybutton>
        {props.isEdit && (
          <S.Mybutton onClick={props.itemUpdate}>수정하기</S.Mybutton>
        )}
        {!props.isEdit && (
          <S.Mybutton onClick={props.itemUpload}>등록하기</S.Mybutton>
        )}
      </S.Wrapper_Mybutton>
    </S.Wrapper>
  );
